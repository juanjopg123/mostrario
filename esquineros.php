        ...
        <div class="row">
            <div class="contenido-producto">
                <div class="product">
                    ...
                    <p class="p-boton"><a href="./detallesesquineros.php?id=<?php echo $row['id'];?>" class="glow-on-hover"> <span></span>Más detalles</a></p>
                </div>
            </div>
        </div>
    </div>
